                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img :src=developer.image class="rounded-circle" width="100%" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-default" id="demo">
                        <div class="card-header">
                            <span class="dpt">گفتگو با توسعه دهنده</span>
...
<script>
    export default {
        ...
        methods: {
            ...
            getProject() {
                axios.get(`/projects/reserved/${this.$route.params.id}`)
            ...
            afterFetchItem(response) {
                ...
                this.getDeveloper(this.project);

            },
            getDeveloper(project) {
                let id = project.id;
                axios.get(`/projects/get-developer/${id}`)
                    .then(response => this.developer = response.data)
                    .catch(error => this.errorNotify(error.response.data.message));
            },
            toggle() {
            ...
            handleSubmit() {
                axios.post(`/messages/${this.$route.params.id}/0`, this.form).then(response => this.afterSendMessage())
                    .catch(error => this.errorNotify(error.response.data.message));
            },
            afterSendMessage() {
                this.getMessages();
        ...
        created() {
            this.getProject();
            this.breadcrumb = [
                {title: 'پروژه های ارسالی', to: '/projects'},
            ];
            setInterval(() => {
                this.getMessages();
            }, 1000);
