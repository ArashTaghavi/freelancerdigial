            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <button class="mt-1 mr-1 btn btn-xs"
                        ...
                        <span class="ml-5" @click="removeSkill(index)">
    ...
    export default {
        data() {
            return {
                ...
                skill: '',
                dropOptions: {
                    url: `/api/client/projects/upload-introduction`,
        ...
        methods: {
            handleSubmit() {
                axios.put(`/projects/${this.$route.params.id}`, this.form).then(response => {
            ...
            afterFetchItem(response) {
                ...
                this.now = response.data.start_date;
                  this.form.skill= response.data.skill !=null ? JSON.parse(response.data.skill) :[];
                this.breadcrumb = [
                    {title: 'پروژه های ارسالی', to: '/projects'},
                    {title: this.form.title, to: `/projects/${this.form.id}/edit`}
                ]
            },
            addSkill() {
                if (this.form.skill !== '')
