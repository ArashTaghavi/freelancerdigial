                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img :src=owner.image class="rounded-circle" width="100%" alt="">
                        ...
                        <div class="card-wrapper collapse">
                            <div class="card-body chat">
                                <div class="row p-3" v-for="message in messages">
                                    <div class="col-md-4 col-sm-6 you" v-if="message.sender_id===me">
                                        {{message.body}}
                                    ...
                                    <div v-else class="col-md-4 col-sm-6 offset-md-8 offset-sm-6 me">
                                        {{message.body}}
                                        <div style="cursor: pointer"
                                             class="text-center pd-2"
                                             v-if="message.attachment!==null"
    ...
    export default {
        data() {
            return {
                ...
                show_image: false,
                dropOptions: {
                    url: `/api/client/messages/upload/file/d`,
        ...
        methods: {
            ...
            afterFetchItem(response) {
                ...
                this.project.skill = JSON.parse(response.data.skill);
                this.project.profile_image = JSON.parse(response.data.profile_image);
                this.getOwner(this.project);
                this.breadcrumb = [
            ...
            getOwner() {
                axios.get(`/reserved-projects/get-owner/${this.$route.params.id}`)
            ...
            getMessages() {
                axios.get(`/messages/get-by-project-id/${this.$route.params.id}`)
                    .then(response => this.messages = response.data)
                    .catch(error => this.errorNotify(error.response.data.message))
            },
            handleSubmit() {
                axios.post(`/messages/${this.$route.params.id}/1`, this.form).then(response => this.afterSendMessage())
                    .catch(error => this.errorNotify(error.response.data.message));
            },
            afterSendMessage() {
                this.getMessages();
