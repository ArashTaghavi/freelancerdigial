        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="p-5" style="line-height: 25px" v-html="company.reviewed.description"></div>
                </div>
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <tr v-for="detail in company.reviewed.details">
...
<script>
    export default {
        ...
        created() {
            axios.get(`/companies/review/${this.$route.params.id}`).then(response => this.afterFetchItem(response)).catch(error => this.errorNotify(error.response.data.message));
        },
        methods: {
            afterFetchItem(response) {
                ...
                this.breadcrumb = [
                    ...
                    {title: this.company.title, to: `/companies`}
                ]
            },
            getAssessment(id) {
                if (id === 1)
