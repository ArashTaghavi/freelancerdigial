        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6" v-if="form.introduction!==null">
                    <br>
                    <span style="font-size: 16px">ویدیو بارگذاری شده</span>
                    <br>
                    <br>
    ...
    export default {
        data() {
            return {
                ...
                categories: [],
                dropOptions: {
                    url: `/api/user/teams/upload-introduction`,
        ...
        methods: {
            handleSubmit() {
                ...
                axios.put(`/teams/${this.$route.params.id}`, this.form).then(response => {
            ...
            afterFetchItem(response) {
                ...
                this.breadcrumb = [
                    {title: 'شرکت ها', to: '/teams'},
                    {title: this.form.title, to: `/teams/${this.form.id}/edit`}
                ];
            },
            addTags() {
