...
<script>
    ...
    export default {
        ...
        created() {
            ...
            axios.get(`/projects/get/${this.$route.params.pid}`)
        ...
        methods: {
            handleSubmit() {
                axios.put(`/projects/${this.$route.params.pid}`, this.form).then(response => {
                    this.successNotify(response.data.message);
                    this.$router.push(`/teams/${this.$route.params.id}/project`)
                }).catch(error => {
            ...
            afterFetchItem(response) {
                ...
                this.form.skill=JSON.parse(response.data.skill);
                this.breadcrumb = [
