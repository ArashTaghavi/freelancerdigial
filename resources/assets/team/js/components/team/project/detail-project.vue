                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <span class="badge badge-info mb-4 mr-1"
                                                      v-for="skill in JSON.parse(project.skill)">
                                                    {{skill}}
                                                </span>
                                ...
                                <div class="row p-3" v-for="message in messages">
                                    ...
                                    <div v-else class="col-md-4 col-sm-6 offset-md-8 offset-sm-6 you">
                                        ...
                                        <div style="cursor: pointer"
                                            ...
                                            <a target="_blank" :href=message.attachment v-else class="btn btn-xs btn-info">
                                                <i class="fa fa-download"></i>
                                                دانلود
                                            </a>
                                        </div>
    ...
    export default {
        data() {
            return {
                ...
                show_image: false,
                dropOptions: {
                    url: `/api/team/messages/upload/file/d`,
        ...
        methods: {
            ...
            getProject() {
                axios.get(`/projects/reserved/${this.$route.params.pid}`)
            ...
            getFunctor() {
                axios.get(`/projects/get-functor/${this.$route.params.pid}`)
            ...
            handleSubmit() {
                axios.post(`/messages/${this.$route.params.pid}`, this.form).then(response => this.afterSendMessage())
                    .catch(error => this.errorNotify(error.response.data.message));
            },
            afterSendMessage() {
                this.getMessages();
