    ...
    <div class="card">
        ...
        <div class="stepwizard">
            <div class="stepwizard-row setup-panel">
                ...
                <div class="stepwizard-step col-xs-3">
                    <router-link :to="``" type="button" class="btn btn-default btn-circle" disabled="disabled">4</router-link>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 text-left mt-3">
                    <div class="form-group">
                        <label for="">لوگو تیم </label>
                        <br>
                        <cropper-portlet v-model="form.profile_image" title="تصویر شرکت" place="left"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <span style="font-size: 16px">ویدیو معرفی تیم</span>
                    <br>
                    <br>
    ...
    export default {
        data() {
            return {
                ...
                categories: [],
                dropOptions: {
                    url: `/api/team/teams/upload-introduction`,
        ...
        methods: {
            handleSubmit() {
                ...
                axios.post(`/teams`, this.form).then(response => {
            ...
            nextStep(response) {
                ...
                this.$router.push(`/teams/${response.data.id}/work-sample`);
            }
        }
    }
</script>
