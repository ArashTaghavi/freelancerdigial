                        ...
                        <div class="tab-pane fade active show" id="app-settings" role="tabpanel">
                            ...
                            <div class="p-2">
                                ...
                                <div class="row row-flush mb-2">
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-a.css">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-b.css">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-c.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-d.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
                                ...
                                <div class="row row-flush mb-2">
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-e.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-f.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-g.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
                                    ...
                                    <div class="col mb-2">
                                        <div class="setting-color">
                                            <label data-load-css="/d-assets/css/theme-h.css">
                                                <input type="radio" name="setting-theme">
                                                <span class="icon-check"></span>
                                                <span class="split">
